...
to init-tower
  ...
  ask tower 2 [setxy 0 10]
  ask tower 3 [setxy 0 -10]
  ask tower 4 [setxy 0 0]
end
...
;permet de passer une unité en leader
...
to deadf
  ifelse leader = 0
  [ set dead "oui" die]
  [ ifelse [shape] of myself = "cow"
    [re_create_leader cows set dead "oui" die]
    [re_create_leader sheeps set dead "oui" die]
